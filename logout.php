...
<body>
    <ul id="menu">
		...
		<center>
			<h1 id="title">You've been loged out</h1>
			<p id="text_subtitle">Thank you for stopping by. We hope to see you again soon.</p>
			<p id="text_subtitle">Until then, safe travels!</p>

			<a href="index.php"><button class="animated_button" type="submit" name="city"><span>Home</span></button></a>
